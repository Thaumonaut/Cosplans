-- Migration: Fix delete user function - use correct column name
-- user_profiles uses 'id' not 'user_id'
-- Date: 2026-01-07

-- Replace the delete user function with corrected column name
...
BEGIN
  ...
  -- Delete user_profiles first (has FK to teams) - uses 'id' column
